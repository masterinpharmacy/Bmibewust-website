        ...
        <Reveal>
          <div className="about-grid">
            <div className="about-card">
              ...
              <p>3 maanden intensieve begeleiding bij BMI Bewust, daarna samen kiezen: doorgaan via reguliere zorg bij apotheek Numansdorp, of stoppen.</p>
            </div>
            <div className="about-card">
      ...
      <section className="section" id="prijzen">
        <Reveal>
          <div className="section-head">
            ...
            <p>BMI Bewust begeleidt je de eerste 3 maanden — geneesmiddelen, coaching en monitoring in één pakket. Daarna bepaal je samen met ons het vervolg, via de reguliere zorg van apotheek Numansdorp.</p>
          </div>
        </Reveal>
          ...
          <Reveal>
            <div className="pricing-card">
              ...
              <div className="pricing-amount">
                <span className="pricing-period">vanaf</span>
                <span className="pricing-number">€1.490</span>
              </div>
              <p className="pricing-note">Eenmalig pakket · prijs is afhankelijk van het voorgeschreven geneesmiddel</p>
