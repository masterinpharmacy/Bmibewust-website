  ...
  return (
    <div className="page">
      ...
      <nav className="nav">
        ...
        <button className="nav-cta">Plan intake</button>
      </nav>
        ...
        <div>
          <Reveal>
            ...
            <div className="hero-actions">
              <button className="btn-primary">Start je intake</button>
              <button className="btn-ghost">Bereken je BMI ↓</button>
            </div>
      ...
      <section style={{ padding: "0 0 4rem" }}>
        <Reveal>
          <div className="cta-final">
            ...
            <button className="btn-primary">Meld je nu aan</button>
          </div>
        </Reveal>
      </section>
