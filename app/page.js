...
const FAQ_SEED = [
  { q: "Wat kost een traject bij BMI Bewust?", a: "Eén vaste prijs van €495 per maand, voor maximaal 6 maanden — ongeacht welk geneesmiddel je krijgt voorgeschreven. Geen verborgen kosten, geen losse facturen per medicijn. Je weet vooraf precies waar je aan toe bent." },
  { q: "Wordt dit vergoed door mijn zorgverzekering?", a: "GLP-1 medicatie wordt in Nederland alleen vergoed bij een medische indicatie zoals diabetes type 2, vastgesteld door je huisarts. Bij gewichtsverlies zonder die indicatie betaal je zelf de vaste maandprijs. We bespreken dit altijd vooraf." },
  { q: "Is dit veilig in vergelijking met online bestellen?", a: "Bij ons werken huisarts, apotheker en diëtist samen aan jouw traject: medicatiebewaking, voedingsadvies en monitoring van bijwerkingen in één team. Bij anonieme onlineverkoop ontbreekt dat volledig." },
  ...
  { q: "Kan ik altijd contact opnemen met mijn coach?", a: "Ja. Naast de vaste controlemomenten kun je 24/7 contact opnemen met je coach bij vragen, twijfels of bijwerkingen. Je staat er nooit alleen voor tussen de afspraken door." },
];

const PRICING_FEATURES = [
  { title: "Eén vaste prijs", body: "€495 per maand, voor maximaal 6 maanden. Ongeacht welk geneesmiddel je krijgt — geen verrassingen achteraf." },
  { title: "24/7 coaching", body: "Vragen of twijfels tussen de afspraken door? Je coach is dag en nacht bereikbaar." },
  { title: "Compleet team", body: "Huisarts, apotheker en diëtist werken samen aan jouw traject — medisch, farmaceutisch en voedingsadvies in één lijn." },
];
    ...
    <div className="page">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .pricing-amount { display: flex; align-items: baseline; gap: 0.4rem; margin-bottom: 0.6rem; }
        .pricing-number { font-family: 'Fraunces', serif; font-size: 3.4rem; font-weight: 700; line-height: 1; }
      ...
      <section className="hero">
        <div>
          <Reveal>
            <span className="hero-eyebrow">Onder begeleiding van huisarts, apotheker &amp; diëtist</span>
      ...
      <section className="section" style={{ paddingTop: "1rem" }}>
        <Reveal>
          <div className="about-grid">
            ...
            <div className="about-card">
              <h3>Drie experts, één plan</h3>
              <p>Huisarts, apotheker en diëtist werken samen: medisch toezicht, medicatiebewaking en voedingsadvies in één lijn.</p>
            </div>
            <div className="about-card">
              <h3>24/7 coaching</h3>
              <p>Vragen tussen de afspraken door? Je coach is dag en nacht bereikbaar — je staat er nooit alleen voor.</p>
            </div>
            <div className="about-card">
      ...
      <section className="section" id="prijzen">
        <Reveal>
          <div className="section-head">
            <p className="section-eyebrow">Helder en zonder verrassingen</p>
            <h2>Eén prijs, geen kleine lettertjes</h2>
            <p>Geen losse facturen per medicijn, geen verborgen kosten. Je weet vooraf precies waar je aan toe bent.</p>
          </div>
        </Reveal>
        <div className="pricing-grid">
          <Reveal>
            <div className="pricing-card">
              <p className="pricing-eyebrow">Vast tarief</p>
              <div className="pricing-amount">
                <span className="pricing-number">€495</span>
                <span className="pricing-period">/ maand</span>
              </div>
              <p className="pricing-note">Maximaal 6 maanden · ongeacht welk geneesmiddel</p>
              <a href="#intake-form" className="btn-primary pricing-cta">Start je intake</a>
            </div>
          </Reveal>
