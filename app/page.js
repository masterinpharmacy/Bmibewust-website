  ...
  return (
    <div className="page">
        ...
        <div>
          <Reveal>
            ...
            <p className="hero-sub">
              ...
              zoals Ozempic, Wegovy en Mounjaro: 3 maanden intensieve begeleiding, geleverd via onze
              partnerapotheek, waarna je samen met ons het vervolg bepaalt.
            </p>
        ...
        <Reveal>
          <div className="about-grid">
            <div className="about-card">
              <h3>Springplank, geen abonnement</h3>
              <p>3 maanden intensieve begeleiding bij BMI Bewust, daarna samen kiezen: doorgaan via reguliere zorg bij onze partnerapotheek, of stoppen.</p>
            </div>
            <div className="about-card">
      ...
      <section className="section" id="prijzen">
        <Reveal>
          <div className="section-head">
            <p className="section-eyebrow">Eén pakket, een duidelijk vervolg</p>
            <h2>Jouw springplank naar duurzame zorg</h2>
            <p>BMI Bewust begeleidt je de eerste 3 maanden — geneesmiddelen, coaching en monitoring in één pakket. Daarna bepaal je samen met ons het vervolg, via de reguliere zorg van onze partnerapotheek.</p>
          </div>
        </Reveal>
        <div className="pricing-grid">
          <Reveal>
            <div className="pricing-card">
              <p className="pricing-eyebrow">Pakketprijs · 3 maanden</p>
              <div className="pricing-amount">
                <span className="pricing-number">€1.490</span>
              </div>
              <p className="pricing-note">Eenmalig pakket · inclusief geneesmiddelen en coaching</p>
